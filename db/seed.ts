...
const seedProducts = async (categoryIds: number[]) => {
  ...
  const products = [
    { name: "Water 0.5L", categoryId: bevId, sellingPrice: "1.50", currentStock: "100" },
    { name: "Cola 0.33L", categoryId: bevId, sellingPrice: "2.00", currentStock: "80" },
    { name: "Chips", categoryId: snacksId, sellingPrice: "2.50", currentStock: "50" },
    { name: "Chocolate bar", categoryId: snacksId, sellingPrice: "1.80", currentStock: "60" },
    { name: "Fuel additive", categoryId: additivesId, sellingPrice: "8.00", currentStock: "20" },
  ];
